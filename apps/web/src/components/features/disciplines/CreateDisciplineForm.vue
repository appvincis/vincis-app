...
<template>
    <Teleport to="body">
        <Transition name="modal">
            <div v-if="showCreateForm" class="fixed inset-0 z-[9999] flex items-center justify-center p-4"
                ...
                <div
                    ...
                    <div class="px-6 pb-6 space-y-5">
                        ...
                        <div>
                            <label
                                class="block text-[10px] font-label font-bold uppercase tracking-[0.15em] text-on-surface-muted mb-2">
                                Nome da Disciplina
                            </label>
                            <input v-model="newName" type="text" placeholder="Ex: Projeto Arquitetônico V"
                        ...
                        <div>
                            ...
                            <textarea v-model="newDescription" placeholder="Breve resumo dos objetivos da disciplina..."
                                rows="3"
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-3">
                                <label
                                    class="text-[10px] font-label font-bold uppercase tracking-[0.15em] text-on-surface-muted">
                                    Importância na Grade (Peso)
                                </label>
                                <span class="text-xs font-label font-bold text-primary">Peso {{ newWeight }}</span>
                            </div>
                            <input type="range" v-model.number="newWeight" min="1" max="5" step="1"
